document.addEventListener('DOMContentLoaded', function () {
  ...
  let backgroundImage = new Image(); // Background image
  ...
  backgroundImage.src = 'assets/images/background2.jpg'; // Replace with the path to your background image
  backgroundImage.onload = function () {
    resizeCanvas(); // Resize and draw images after the background image is loaded
  };
